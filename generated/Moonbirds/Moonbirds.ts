...
export class Moonbirds__nestingPeriodResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class Moonbirds__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class Moonbirds__sellerConfigResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Moonbirds extends ethereum.SmartContract {
  static bind(address: Address): Moonbirds {
    return new Moonbirds("Moonbirds", address);
  }
  ...
  nestingPeriod(tokenId: BigInt): Moonbirds__nestingPeriodResult {
    let result = super.call(
      "nestingPeriod",
    ...
    return new Moonbirds__nestingPeriodResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_nestingPeriod(
    tokenId: BigInt
  ): ethereum.CallResult<Moonbirds__nestingPeriodResult> {
    let result = super.tryCall(
      "nestingPeriod",
      "nestingPeriod(uint256):(bool,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    return ethereum.CallResult.fromValue(
      new Moonbirds__nestingPeriodResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  royaltyInfo(
    ...
    return new Moonbirds__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    _tokenId: BigInt,
    _salePrice: BigInt
  ): ethereum.CallResult<Moonbirds__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Moonbirds__royaltyInfoResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
  ...
  sellerConfig(): Moonbirds__sellerConfigResult {
    let result = super.call(
      "sellerConfig",
    ...
    return new Moonbirds__sellerConfigResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_sellerConfig(): ethereum.CallResult<Moonbirds__sellerConfigResult> {
    let result = super.tryCall(
      "sellerConfig",
      "sellerConfig():(uint256,uint256,uint256,uint248,bool,bool,bool)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Moonbirds__sellerConfigResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
